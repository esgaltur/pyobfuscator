...
- Does not provide runtime protection (bytecode can still be analyzed)
...
PyObfuscate is a simpler alternative that provides source-code level obfuscation without the licensing restrictions.
